...
function cParticleEmitter(o){
	...
	this.positionRandom = o.positionRandom;
	this.size = o.size;
	this.sizeRandom = o.sizeRandom;
	this.speed = o.speed;
	this.speedRandom = o.speedRandom;
	this.lifeSpan = o.lifeSpan;
	this.lifeSpanRandom = o.lifeSpanRandom;
	this.angle = o.angle;
	this.angleRandom = o.angleRandom;
	this.gravity = o.gravity;
	this.startColour = o.startColour;
	this.startColourRandom = o.startColourRandom;
	this.finishColour = o.finishColour;  
	this.finishColourRandom = o.finishColourRandom;
	this.sharpness = o.sharpness;
	this.sharpnessRandom = o.sharpnessRandom;
	this.clearrect = o.clearrect;
	this.increaseRandomPosition = o.increaseRandomPosition;
	this.deletearea = o.deletearea;
	this.hasStars = o.hasStars;
	this.fixedStartColor = o.fixedStartColor;
	this.fixedEndColor = o.fixedEndColor;
	...
	this.renderParticles = function( context ){
		//if(this.clearrect) context.clearRect(0,0,1280,584);
		
		if(this.increaseRandomPosition)
		{
			this.n++;
			this.positionRandom.x+=this.n;
			this.positionRandom.y+=this.n;
			this.size+=this.n;
		}
		...
		for( var i = 0, j = this.particleCount; i < j; i++ ){
			...
			var radgrad = context.createRadialGradient( x + halfSize, y + halfSize, particle.sizeSmall * 1.1, x + halfSize, y + halfSize, halfSize);  
			
			var sc = (this.fixedStartColor) ? this.fixedStartColor : particle.drawColour;
			var ec = (this.fixedEndColor) ? this.fixedEndColor : 'rgba(0,0,0,0)';
			
			
			radgrad.addColorStop( 0, sc );   
			radgrad.addColorStop( 1, ec ); //Super cool if you change these values (and add more colour stops)
